...
?>
	...
	<form>			
		<INPUT id="button1" TYPE="button" value="Profildaten ändern" onClick="window.location.href = 'profildaten_aendern.php';">			
	</form>
	<form>			
		<INPUT id="button2" TYPE="button" value="Passwort ändern" onClick="window.location.href = 'passwort_aendern.php';">			
	</form>
	<form>			
		<INPUT id="button2" TYPE="button" value="Status ändern" onClick="window.location.href = 'anwesenheitsstatus_aendern.php';">			
	</form>
	<form>			
		<INPUT id="button2" TYPE="button" value="Chat-Board" onClick="window.location.href = 'chat-board.php';">			
	</form>
	<form>			
		<INPUT id="button2" TYPE="button" value="Nach Benutzer suchen" onClick="window.location.href = 'suche_benutzer.php';">			
	</form>
	<form>			
		<INPUT id="button2" TYPE="button" value="Logout" onClick="window.location.href = 'logout.php';">			
	</form>
